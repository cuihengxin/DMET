...
def _ao2mo_df(mycc, mo_coeff=None):
    ...
    # AO->MO coefficients are required in dfuccsd integral contractions.
...
class DF_UHF_EMB(uhf_tool.UHF_EMB):
    def __init__(self, mol, mf, es_orb, fo_orb, es_dm, es_cderi):
        ...
        super(uhf_tool.UHF_EMB, self).__init__(mol)  # skip UHF_EMB init 
