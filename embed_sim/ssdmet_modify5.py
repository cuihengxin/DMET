...
class SSDMET(lib.StreamObject):
    ...
    def lowdin_orth(self, basis_rot, restore_imp = False):
    ...
    def build(self, basis_rot, restore_imp = False, chk_fname_load='', save_chk=True):
        self.dump_flags()
        ...
        if not loaded:
            ldm, caolo, cloao = self.lowdin_orth(basis_rot, restore_imp)
