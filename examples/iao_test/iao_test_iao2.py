...
mydmet = ssdmet.SSDMET(mf, title=title, imp_idx=imp, bath_option={'ROMP2':1e-6},es_natorb=False).density_fit()
# if impurity is not assigned, the orbitals on the first atom is chosen as impurity
mydmet.build(iaopao='IAOPAO',restore_imp =False, save_chk=False, ip_iao=None, imp4ip=imp2)
