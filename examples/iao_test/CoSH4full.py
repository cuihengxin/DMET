...
mydmet = ssdmet.SSDMET(mf, title=title, imp_idx=imp2, bath_option={'ROMP2':1e-10},es_natorb=False).density_fit()
# if impurity is not assigned, the orbitals on the first atom is chosen as impurity
mydmet.build(iaopao=None,restore_imp =False, save_chk=False, ip_iao=None, imp4ip=imp2)
