...
mol = gto.M(atom = " H                 -1.68070180    1.28654969    0.00000000; H                 -2.28070180    1.28654969    0.00000000", basis = {'Co':' def2tzvp', 'S':'def2tzvp','C':'6-31G*', 'H':'ccpvtz'}, symmetry=0, spin = 0, charge = 0, verbose = 4)
...
mydmet = ssdmet.SSDMET(mf, title = title, imp_idx = ('H.*'),threshold = 1e-12)
mydmet.build()

# run ccsdt
e_tot = mydmet.ccsdt_solver()

mydmet2 = ssdmet.SSDMET(mf, title = title+'_2', imp_idx = ('H.1'),threshold = 1e-12)
